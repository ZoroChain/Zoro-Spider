...
namespace Zoro.Spider
{
    class ZoroHelper
    {
        ...
        public static async Task<string> InvokeScript(byte[] script, string chainHash)
        {
            ...
            url = Helper.MakeRpcUrlPost(Settings.Default.RpcUrl, "invokescript", out postdata, postArray);
        ...
        public static async Task<string> SendRawTransaction(string rawdata, string chainHash)
        {
            ...
            url = Helper.MakeRpcUrlPost(Settings.Default.RpcUrl, "sendrawtransaction", out postdata, postRawArray);
